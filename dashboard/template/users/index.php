...
<html lang="en">
  <head>
    <!-- Required meta tags -->
    <title> Dashboard | Myfxvpsm</title>
          ...
          <div class="content-wrapper">
                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      ...
                      <div class="col-5 col-sm-7 col-xl-8 p-0">
                        <h4 class="mb-1 mb-sm-0">Welcome to Myfxvpsm</h4>
                        <p class="mb-0 font-weight-normal d-none d-sm-block">We are dedicated to serving you better!</p>
                      </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                      <div class="text-md-center text-xl-left">
                        <h6 class="mb-1">Local Bank Transfer</h6>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-row justify-content-between">
                      <h4 class="card-title mb-1">Your Subscriptions</h4>
                      <p class="text-muted mb-1">Approved Subscriptions </p>
                    </div>
                    <div class="row">
                      <div class="col-12">
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Your Visits</h4>
                    <div class="row">
                      <div class="col-md-5">
                        <div class="table-responsive">
                          <table class="table">
