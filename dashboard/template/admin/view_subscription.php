...
<html lang="en">
  <head>
    <!-- Required meta tags -->
    <title>Edit Subscription | Myfxvpsm</title>
...
<div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <button onclick="history.back()" class="btn btn-danger float-right mb-2">Go back</button>
                    ...
                    <div class="row mx-0">
                      ...
                      <label for="duration">Customer's Name</label>
                      <div class="p-3 rounded border border-light" ><span id="customer"></span></div>
                    <div class="row mt-3">
                    <div class="form-group col-md-6">
                      <label for="duration">Email</label>
                      <div class="p-3 rounded border border-light" ><a href="" id="email"></a></div>
                      </div>
                    <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control p_input text-white border-light" id="Username" placeholder="Input vps username">
                  </div>
                  <div class="form-group">
                    <label>Password</label>
                    <input type="text" id="Password" class="form-control p_input text-white border-light" placeholder="Input vps password">
                  </div>
                  <div class="form-group">
                    <label>Ip Address</label>
                    <input type="text" class="form-control p_input text-white border border-light" id="Ip" placeholder="Input vps Ip">
                  </div>
                  <div class="form-group">
                  <img src="../assets/images/loading.gif" alt="" id="load_ing" style="display: none;">
